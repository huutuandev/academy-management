package com.tuan.center.security.jwt;

import com.tuan.center.security.user.UserDetailsServiceImpl;
        ...
        try {
            ...
            if (username != null && SecurityContextHolder.getContext().getAuthentication() == null) {
                ...
                if (!jwtService.isTokenExpired(token)) {
                    ...
                    log.debug("JWT authentication thành công cho user: {}", username);
                }
            }
